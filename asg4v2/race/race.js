...
class Race {
    ...
    getLeaderboards() {
        ...
        //for(let i = 0; i < 10; i++)
        //{
            //console.log("leaderboards before sort: " + leaderboards[i].progress);
        //}
        leaderboards.sort((a, b) => (a.progress < b.progress) ? 1 : -1);
        //for(let i = 0; i < 10; i++)
        //{
            //console.log("leaderboards after sort: " + leaderboards[i].progress);
        //}

        return leaderboards;
    }

    getCarFeatures(index)
    {
        let newFeats = this.leaderboards[index].feats;
        return newFeats;
